...
import datetime
client = MongoClient("mongodb+srv://Fares:<HilSkill7007>@cluster0.rx8wd.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
db = client["market"]
collection1 = db["test"]
...
client = MongoClient("mongodb+srv://Fares:<HilSkill7007>@cluster0.rx8wd.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
db = client["testdata"]
collection1 = db["check"]
collection3 = db["not_for_you"]
